    ...
    return (
      ...
      <div> 
        ...
        <h1 className='tc f3 dark-blue'> Trivia
            ...
            <p className="f5 grow br-pill ba bw2 ph3 pv1 mb1 dib dark-blue" onClick={this.getTrivia}>Go</p>
        </h1>
        
        <h1 className='tc f3 dark-blue'> Math 
            <input type='number' className='w5 mh4' placeholder='Enter Number' id='mathInput' />
            <p className="f5 grow br-pill ba bw2 ph3 pv1 mb1 dib dark-blue" onClick={this.getMath}>Go</p>
        </h1>
        
        <h1 className='tc f3 dark-blue'> Date 
            <input className='w5 mh4 gray' type='text' placeholder='Format MM/DD' id='dateInput' />
            <p className="f5 grow br-pill ba bw2 ph3 pv1 mb1 dib dark-blue" onClick={this.getDate}>Go</p>
        </h1>
        
        <h1 className='tc f3 dark-blue'> Year 
            <input className='w5 mh4' type='year' placeholder='Enter Year' id='yearInput' />
            <p className="f5 grow br-pill ba bw2 ph3 pv1 mb1 dib dark-blue" onClick={this.getYear}>Go</p>
        </h1>
